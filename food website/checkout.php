...
<form action="" method="post">
   ...
   <div class="user-info">
      ...
      <select name="method" class="box" required>
         <option value="" disabled selected>lựa chọn cách thức thanh toán --</option>
         <option value="cash on delivery">trả tiền khi nhận hàng</option>
         <option value="credit card">credit card</option>
         <option value="paytm">paytm</option>
         <option value="paypal">paypal</option>
      </select>
      <input type="submit" value="ĐẶT MÓN" class="btn <?php if($fetch_profile['address'] == ''){echo 'disabled';} ?>" style="width:100%; background:var(--red); color:var(--white);" name="submit">
   </div>
